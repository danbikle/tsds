 ...
 * Effectiveness of a prediction is easy to compute.
 * I get the absolute-value of Effectiveness from absolute-value of pctlead.
 * If the prediction is True, Effectiveness is positive.
 * If the prediction is False, Effectiveness is negative.
